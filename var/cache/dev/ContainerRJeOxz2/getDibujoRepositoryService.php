 ...
 */
class getDibujoRepositoryService extends App_KernelDevDebugContainer
{
    /**
     * Gets the private 'App\Repository\DibujoRepository' shared autowired service.
     *
     * @return \App\Repository\DibujoRepository
     */
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'src'.\DIRECTORY_SEPARATOR.'Repository'.\DIRECTORY_SEPARATOR.'DibujoRepository.php';

        return $container->privates['App\\Repository\\DibujoRepository'] = new \App\Repository\DibujoRepository(($container->services['doctrine'] ?? $container->getDoctrineService()));
    }
}
