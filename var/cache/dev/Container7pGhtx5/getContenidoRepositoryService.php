...
class getContenidoRepositoryService extends App_KernelDevDebugContainer
{
    ...
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'src'.\DIRECTORY_SEPARATOR.'Repository'.\DIRECTORY_SEPARATOR.'ContenidoRepository.php';

        return $container->privates['App\\Repository\\ContenidoRepository'] = new \App\Repository\ContenidoRepository(($container->services['doctrine'] ?? $container->getDoctrineService()));
    }
}
